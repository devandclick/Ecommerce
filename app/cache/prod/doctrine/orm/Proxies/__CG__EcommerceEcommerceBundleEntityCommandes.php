 ...
 */
class Commandes extends \Ecommerce\EcommerceBundle\Entity\Commandes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'id', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'utilisateur', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'valider', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'date', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'reference', '' . "\0" . 'Ecommerce\\EcommerceBundle\\Entity\\Commandes' . "\0" . 'commande');
        }
