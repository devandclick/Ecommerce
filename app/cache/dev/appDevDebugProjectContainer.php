...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'validator.check.url' => 'getValidator_Check_UrlService',
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/www/Ecommerce/app/cache/dev/assetic/config'), true)));
    ...
    /**
     * Gets the 'curlurl' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Pages\PagesBundle\Services\CurlUrl A Pages\PagesBundle\Services\CurlUrl instance.
     */
    protected function getCurlurlService()
    {
        return $this->services['curlurl'] = new \Pages\PagesBundle\Services\CurlUrl();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_061208f0f330c71ea9162e68c13c2811004dc11c8a832c133ad9d45cf17c225e');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_061208f0f330c71ea9162e68c13c2811004dc11c8a832c133ad9d45cf17c225e');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_061208f0f330c71ea9162e68c13c2811004dc11c8a832c133ad9d45cf17c225e');
        ...
        $f->addDriver($e, 'Pages\\PagesBundle\\Entity');
        $f->addDriver($e, 'Utilisateurs\\UtilisateursBundle\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array('C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle\\Resources\\config\\doctrine\\model' => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('EcommerceBundle' => 'Ecommerce\\EcommerceBundle\\Entity', 'PagesBundle' => 'Pages\\PagesBundle\\Entity', 'UtilisateursBundle' => 'Utilisateurs\\UtilisateursBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('C:/wamp/www/Ecommerce/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), 'C:/wamp/www/Ecommerce/app/cache/dev', array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'EcommerceBundle' => 'Ecommerce\\EcommerceBundle\\EcommerceBundle', 'PagesBundle' => 'Pages\\PagesBundle\\PagesBundle', 'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle', 'UtilisateursBundle' => 'Utilisateurs\\UtilisateursBundle\\UtilisateursBundle', 'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle', 'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle', 'LiipImagineBundle' => 'Liip\\ImagineBundle\\LiipImagineBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    {
        return $this->services['liip_imagine.binary.loader.default'] = new \Liip\ImagineBundle\Binary\Loader\FileSystemLoader($this->get('liip_imagine.mime_type_guesser'), $this->get('liip_imagine.extension_guesser'), 'C:/wamp/www/Ecommerce/app/../web');
    }
    ...
    {
        return $this->services['liip_imagine.cache.resolver.default'] = new \Liip\ImagineBundle\Imagine\Cache\Resolver\WebPathResolver($this->get('filesystem'), $this->get('router.request_context'), 'C:/wamp/www/Ecommerce/app/../web', 'media/cache');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array()), 'produitThumb' => array('quality' => 80, 'filters' => array('thumbnail' => array('size' => array(0 => 300, 1 => 150), 'mode' => 'inset')), 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL), 'produit' => array('quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 470, 1 => 310), 'mode' => 'inset')), 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL)));
    }
    ...
    {
        return $this->services['liip_imagine.filter.loader.paste'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\PasteFilterLoader($this->get('liip_imagine'), 'C:/wamp/www/Ecommerce/app');
    }
    ...
    {
        return $this->services['liip_imagine.filter.loader.watermark'] = new \Liip\ImagineBundle\Imagine\Filter\Loader\WatermarkFilterLoader($this->get('liip_imagine'), 'C:/wamp/www/Ecommerce/app');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ar.yml', 'ar', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.bg.yml', 'bg', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ca.yml', 'ca', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.cs.yml', 'cs', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.da.yml', 'da', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.de.yml', 'de', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.el.yml', 'el', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.en.yml', 'en', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.es.yml', 'es', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.et.yml', 'et', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fa.yml', 'fa', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fi.yml', 'fi', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.he.yml', 'he', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.hr.yml', 'hr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.hu.yml', 'hu', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.id.yml', 'id', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.it.yml', 'it', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ja.yml', 'ja', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lb.yml', 'lb', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lt.yml', 'lt', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.lv.yml', 'lv', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.nb.yml', 'nb', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.nl.yml', 'nl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pl.yml', 'pl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pt.yml', 'pt', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.pt_BR.yml', 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ro.yml', 'ro', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.ru.yml', 'ru', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sk.yml', 'sk', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sl.yml', 'sl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sr_Latn.yml', 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.sv.yml', 'sv', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.th.yml', 'th', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.tr.yml', 'tr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.uk.yml', 'uk', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.vi.yml', 'vi', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\FOSUserBundle.zh_CN.yml', 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ar.yml', 'ar', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.bg.yml', 'bg', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ca.yml', 'ca', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.cs.yml', 'cs', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.da.yml', 'da', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.de.yml', 'de', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.el.yml', 'el', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.en.yml', 'en', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fa.yml', 'fa', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fi.yml', 'fi', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.he.yml', 'he', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.hr.yml', 'hr', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.hu.yml', 'hu', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.id.yml', 'id', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ja.yml', 'ja', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.lt.yml', 'lt', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.lv.yml', 'lv', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.nb.yml', 'nb', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.nl.yml', 'nl', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pl.yml', 'pl', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pt.yml', 'pt', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.pt_BR.yml', 'pt_BR', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ro.yml', 'ro', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.ru.yml', 'ru', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sk.yml', 'sk', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sl.yml', 'sl', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sr_Latn.yml', 'sr_Latn', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.sv.yml', 'sv', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.th.yml', 'th', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.tr.yml', 'tr', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.uk.yml', 'uk', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.vi.yml', 'vi', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/translations\\validators.zh_CN.yml', 'zh_CN', 'validators');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('pathDefault', 'http://localhost/ecommerce/web/');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle/Resources/views', 'FOSUser');
        ...
        $instance->addPath('C:\\wamp\\www\\Ecommerce\\vendor\\liip\\imagine-bundle\\Liip\\ImagineBundle/Resources/views', 'LiipImagine');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'validatorCheckUrl' => 'validator.check.url')));
        $instance->setTranslator($this->get('translator.default'));
        $instance->setTranslationDomain('validators');
        $instance->addXmlMappings(array(0 => 'C:\\wamp\\www\\Ecommerce\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle\\Resources\\config\\validation.xml'));
        ...
        $instance->addXmlMapping('C:\\wamp\\www\\Ecommerce\\vendor\\friendsofsymfony\\user-bundle\\DependencyInjection\\Compiler/../../Resources/config/validation/orm.xml');

        return $instance;
    }

    /**
     * Gets the 'validator.check.url' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Pages\PagesBundle\Validator\Constraints\contraintsCheckUrlValidator A Pages\PagesBundle\Validator\Constraints\contraintsCheckUrlValidator instance.
     */
    protected function getValidator_Check_UrlService()
    {
        return $this->services['validator.check.url'] = new \Pages\PagesBundle\Validator\Constraints\contraintsCheckUrlValidator($this->get('curlurl'));
    }
