...
class __TwigTemplate_977d9458906a1138a32f4a136bd206449269eadbb23210a6693ae11f72a6abb9 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_fe33002921138061ef89460274bd7f91f655ae90fdcfbb1c48cb5b51d0a89fe8"] = $this;
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "data", array()), "forms", array()))) {
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 188
                echo "                    ";
                echo $context["__internal_fe33002921138061ef89460274bd7f91f655ae90fdcfbb1c48cb5b51d0a89fe8"]->getform_tree_entry($context["formName"], $context["formData"], true);
                echo "
                ";
            }
            ...
            foreach ($context['_seq'] as $context["formName"] => $context["formData"]) {
                // line 194
                echo "                ";
                echo $context["__internal_fe33002921138061ef89460274bd7f91f655ae90fdcfbb1c48cb5b51d0a89fe8"]->getform_tree_details($context["formName"], $context["formData"], $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : $this->getContext($context, "collector")), "data", array()), "forms_by_hash", array()));
                echo "
            ";
            }
            $_parent = $context['_parent'];
